...
file = "#{ENV['PCF_ENVIRONMENT']}-deployed_products.yml"
...
File.delete("#{wrkdir}/#{ENV['PCF_ENVIRONMENT']}-deployed_products.yml") if File.exist?("#{wrkdir}/#{ENV['PCF_ENVIRONMENT']}-deployed_products.yml")
